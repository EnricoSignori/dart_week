...
import 'package:dart_week_api/routers/transaction_router.dart';
import 'package:dart_week_api/routers/user_router.dart';
...
class DartWeekApiChannel extends ApplicationChannel {
  ...
  Controller get entryPoint {
    ...
    UserRouter.config(router, context);
    CategoryRouter.config(router, context);
    TransactionRouter.config(router, context);
